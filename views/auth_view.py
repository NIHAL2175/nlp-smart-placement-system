...
def render_footer():
    ...
    with foot_col2:
        ...
        st.markdown(
            "<span style='font-size: 0.9em; color: #a0a0a0;'>📍 **Campus:** Podanur,Coimbatore</span>",
            unsafe_allow_html=True)
        st.markdown("<br>", unsafe_allow_html=True)
        st.markdown("<span style='font-size: 0.9em; color: #a0a0a0;'>✉️ **Email:** supportus@its.edu.in</span>",
                    unsafe_allow_html=True)
    ...
    with foot_col3:
        ...
        <ul>
            <li><b>Nihal N</b> (Lead Architect)</li>
        </ul>
        </div>
        """, unsafe_allow_html=True)
